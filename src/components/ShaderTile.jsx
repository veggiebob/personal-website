    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow duration-300 mb-8">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 flex flex-col">
          ...
          <div className="p-6 gradient-primary text-content-inverse flex-shrink-0">
          ...
          {/* Description */}
          <div className="p-6 flex-grow text-content-secondary text-sm leading-relaxed">
            {description}
          </div>
          ...
          <div className="px-6 pb-6 mt-auto">
            <a 
              ...
              className="inline-flex items-center px-4 py-2 btn-primary text-sm font-medium rounded-md transition-colors duration-200"
            >
